...
import CommentTableItem from '../../components/admin/CommentsTableItem'
    ...
    <div className='flex-1 pt-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className='flex justify-between items-center max-w-3xl'>
        ...
        <div className='flex gap-4'>
          ...
          <button onClick={()=> setFilter('Approved')} className={`shadow-custom-sm border rounded-full px-4 py-q cursor-pointer text-xs 
            ${filter === 'Approved' ? 'text-primary' : 'text-gray-700'}`}>Approved</button>

          <button onClick={()=> setFilter('Not Approved')} className={`shadow-custom-sm border rounded-full px-4 py-q cursor-pointer text-xs 
